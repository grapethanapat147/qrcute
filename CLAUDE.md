...
5. **สี QR ต้องมาจากผู้ใช้เท่านั้น ห้ามเปลี่ยนตาม theme ของเว็บ** — dark mode ของเว็บ
   ต้องไม่พลิกสี QR เด็ดขาด และทุกชุดสีต้องผ่านเกณฑ์ contrast ใน `src/lib/qr/style.ts`
   (แก้ไขจากข้อความเดิม "ดำ/ขาวล้วนเสมอ" เมื่อ 6 ก.ย. 2026 ตอนเปิดให้ปรับแต่งสีได้)
6. **ตัวเลือกดีไซน์ทุกตัวที่ปล่อยออกไปต้องผ่านการ decode จริง** ที่ขนาดภาพซึ่งปัดให้
   หารจำนวน module ลงตัวหลายค่า — ตัวเลือกที่สแกนติดบ้างไม่ติดบ้างห้ามปล่อย
